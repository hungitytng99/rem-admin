...
export default function CardListProducts(props) {
  const { listProducts = { listProductReturn: [] }, handleDeleteProduct, handleSetHotProduct } = props;
      ...
      >
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              {
                listProducts.listProductReturn.length === 0 && <tr>
              ...
              {
                listProducts.listProductReturn.map((product) => {
                  return (
                    <tr key={product.id}>
